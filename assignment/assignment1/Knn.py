...
X_train_folds = [] # list 5: ----> (1000,3072)  --->(3072,1)
y_train_folds = []
################################################################################                                                                      #
...
for i in indices:
    X_train_folds.append(X_train[i]) #X_train[0] (3072,) X_train[999] (3072,)
...
for k in k_choices:
    ...
    for i in range(num_folds):
        ...
        x = np.concatenate(x, axis=0)  # 使用concatenate将4个训练集拼在一起(4000,3072)
